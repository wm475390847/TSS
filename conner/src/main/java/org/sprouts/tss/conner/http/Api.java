package org.sprouts.tss.conner.http;

import org.sprouts.tss.conner.config.HttpConfig;
import org.sprouts.tss.conner.enums.MethodEnum;
import org.sprouts.tss.conner.exception.ConnerException;
import org.sprouts.tss.conner.response.ResponseLog;
import lombok.Data;
...
public class Api {
    ...
    public Api(Builder builder) {
        this.formDataParams.putAll(builder.formDataParams);
    ...
    public static class Builder {
        ...
        public Builder formDataParams(Map<String, String> formDataParts) {
            this.formDataParams.putAll(formDataParts);
            return this;
        }
        ...
        public Builder partFile(PartFile partFile) {
