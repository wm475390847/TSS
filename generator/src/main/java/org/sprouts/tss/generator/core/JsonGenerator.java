 ...
 */
@Slf4j
public class JsonGenerator extends BaseGenerator<ApiInfo> {
    private final JsonParse<ApiInfo> parse;

    public JsonGenerator(Builder builder) {
        super(builder);
    ...
    public static class Builder extends BaseBuilder<JsonGenerator.Builder, ApiInfo> {
        private JsonParse<ApiInfo> parse;
